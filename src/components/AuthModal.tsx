...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleQuickRegister = (e: React.FormEvent) => {
    ...
    const isSuperAdmin = userEmail.toLowerCase() === 'shovqiddin45@gmail.com';
    ...
    const newUser: User = {
      ...
      telegram: '@student_' + autoId.slice(-4),
      isBlocked: false,
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const entered = studentIdInput.trim().toLowerCase();
    // Super Admin faqat shovqiddin45@gmail.com orqali kirishi ta'minlanadi
    const isSuperAdmin = entered === 'shovqiddin45@gmail.com';
  ...
  const handleOneClickOAuth = (provider: 'google' | 'apple') => {
    ...
    const oauthUser: User = {
      id: mockId,
      name: provider === 'google' ? 'Google Foydalanuvchi' : 'Apple Foydalanuvchi',
      email: `${provider}_user_${mockId.slice(-4)}@gmail.com`,
      role: 'student',
      balance: 50000,
      university: 'TATU',
      faculty: 'Dasturiy injiniring',
